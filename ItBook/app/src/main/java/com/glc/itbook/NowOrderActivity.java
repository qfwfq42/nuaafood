...
public class NowOrderActivity extends AppCompatActivity {
    ...
    private void showOrder(int orderid){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(NowOrderActivity.this);
            ...
            public void onResponse(JSONArray jsonElements) {
                ...
                if (ps.size()>0) {
                    ...
                    if(ps.get(0).getorderState().equals("doing")){
                        zhuangtai.setText("现在状态:等待配送中");
                    }
                    else if(ps.get(0).getorderState().equals("waiting")){
                        zhuangtai.setText("现在状态:等待拼单中");
                    }
                    ...
                    Toast.makeText(NowOrderActivity.this, "信息已过期，请刷新后重试！", Toast.LENGTH_SHORT).show();
                }
            }
        }
        , new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(NowOrderActivity.this, "网络出错", Toast.LENGTH_SHORT).show();
            }
        }
        );
            ...
            public void onResponse(JSONArray jsonElements) {
                ...
                adapter = new BaseAdapter() {
                    ...
                    public View getView(final int i, View view, ViewGroup viewGroup) {
                        view = View.inflate(NowOrderActivity.this, R.layout.item_order_apply, null);
                        ...
                        if(ps.get(i).getApplyState().equals("noanswer")) {
                            tongyi.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    AlertDialog aldg;
                                    AlertDialog.Builder adBd=new AlertDialog.Builder(NowOrderActivity.this);
                                    adBd.setTitle("是否确定？");
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
                                                ...
                                                public void onResponse(JSONObject jsonObject) {
                                                    try {
                                                        ...
                                                        if(info1.equals("回复成功")){
                                                            Toast.makeText(NowOrderActivity.this, "回复成功", Toast.LENGTH_SHORT).show();
                                                        }else {
                                                            Toast.makeText(NowOrderActivity.this, "状态已过期，请刷新", Toast.LENGTH_SHORT).show();
                                                        }
                                                ...
                                                public void onErrorResponse(VolleyError volleyError) {
                                                    ...
                                                    Toast.makeText(NowOrderActivity.this, "网络失败", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                                ...
                                                public void onResponse(JSONObject jsonObject) {
                                                    try {
                                                        ...
                                                        if(info1.equals("拒绝成功")){
                                                            Toast.makeText(NowOrderActivity.this, "拒绝成功", Toast.LENGTH_SHORT).show();
                                                        }else {
                                                            Toast.makeText(NowOrderActivity.this, "状态已过期，请刷新", Toast.LENGTH_SHORT).show();
                                                        }
                                                    } catch (JSONException e) {
